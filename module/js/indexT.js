                ...
                $.ajax({
                  ...
                  success: function (res) {
                    ...
                    var request_number3 = JSON.stringify({
                      billNo: numberCode,//票据号
                      billBatchCode: loadList[index].billBatchCode,//电子票据代码
                      pBillBatchCode: "151060117",
                      pBillNo: numberCode,
                      busDateTime: loadList[index].ivcDateTime,
                      placeCode: "00000",//开票点
                      operator: '自助机01'

                    })
                    console.log("电子票据号" + loadList[index].billBatchCode)
                    ...
                    $.ajax({
                      ...
                      success: function (res) {
                        ...
                        //     "<Data>" +
                        //     "<Ecinc_code>" + loadList[index].billBatchCode + "</Ecinc_code>" +
                        //     "<Ecincno>" + loadList[index].billNo + "</Ecincno>" +
                        //     "<Pinc_code>" + '151060117' + "</Pinc_code>" +
                        //     "<Pincno>" + numberCode + "</Pincno>" +
                        //     "</Data >"
                        //     +
                        //     "</iihparam>"].join('')
                        // );
...
function getTime () {
  ...
  var startTime = bgnDate.getFullYear() + "" + Appendzero(bgnDate.getMonth() + 1) + "" + Appendzero(bgnDate.getDate() - 7) + "235900000"
...
function getEndTime () {
  var bgnDate = new Date();
  var endTime = bgnDate.getFullYear() + "" + Appendzero(bgnDate.getMonth() + 1) + "" + Appendzero(bgnDate.getDate()) + "235959000"
  return endTime;
}
